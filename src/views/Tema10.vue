...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-4(data-aos="fade-down-right") La gestión del talento humano es una de las funciones sustantiva, para la dinámica empresarial, es una función de logística para toda la empresa pues se encarga de suministrar el talento humano para el desarrollo de las actividades de la empresa, lo que exige un ejercicio de planeación de las iniciativas estratégicas que se deriven del diagnóstico empresarial, vela por la organización y estructura empresarial, de tal manera que establece mecanismos para su operación como es la estructuración de los cargos como agrupaciones de actividades similares, generando los manuales pertinentes a los proceso donde participe cada trabajador. La Gestión del talento humano está íntimamente ligada al proceso administrativo, pues a partir de las necesidades sociales de la empresa se dispondrá de recursos, se tendrá que hacer gestiones de dirección bajo el estilo que requiera la empresa: autocrático cuando se requieren decisiones rápidas, liberal, cuando el grado de madurez laboral permite que se delegue, para que la gerencia se concentre en otras actividades de propias de su cargo, o el democrático que basado en el consenso se toman las decisiones.
    .row.justify-content-center.align-items-center
      .col-xxl-6.col-xl-6.col-lg-6.col-md-12.mb-4.mb-lg-0(data-aos="fade-down-left")
        p Una buena gestión de talento humano se ocupa de funciones vitales para la empresa como es el desarrollo de clima laboral, el reclutamiento y selección de personal, vela por la seguridad e higiene de sus trabajadores y las condiciones donde presta el servicio, es generador de nuevas capacidades productivas a partir del liderazgo de planes de capacitación y entrenamiento. Al igual la gestión de recursos humanos exige la evaluación del desempeño de los trabajadores vista como una oportunidad de mejorar los procesos, identificar necesidades del personal para que puedan desarrollar bien su trabajo. Y no podía faltar el que se encarga de administrar el sistema de compensaciones y beneficios, el cual debe estar acorde a las condiciones promedio del sector.
      .col-xxl-6.col-xl-6.col-lg-6.col-md-12(data-aos="fade-down-right")     
        img(src='@/assets/curso/tema10/imagen3.jpg')
</template>
