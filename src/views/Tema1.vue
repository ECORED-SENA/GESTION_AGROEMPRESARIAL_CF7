...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .titulo-sexto.color-acento-botones.mb-0
      h5 Tabla 1
    span.mb-4.ms-4 Tipos de actividades empresariales por categorías del sector agropecuario
    .tabla-a.my-5.align-items-left
      table
        thead
          tr
      ...
      .col-xxl-6.col-xl-6.col-lg-6.col-md-12(data-aos="fade-up-right")
        AcordionA.otroacordion1.mb-5(tipo="a" clase-tarjeta="tarjeta fondo2")
          .row.justify-content-center.align-items-center(titulo="Los objetivos")
            ...
            .col-md-3.col-sm-4.col-4.my-0.p-0
              figure
    ...
    p Dentro de la estructura organizacional podemos definir cómo será el ordenamiento funcional, es decir por el conjunto de actividades afines, que conforman los departamentos o áreas de la empresa.
    p.mb-5 Toda empresa tiene tres funciones básicas:
    ...
    p.my-5 Se recomienda que toda empresa agropecuaria defina todas las dependencias de la empresa, para una mejor comprensión de la organización y sus dependencias. Esto sirve de base en los procesos de comunicación y de mejora continua.
    .row.my-4.align-items-center(data-aos="fade-down-right")
      .col-xxl-1.col-xl-1.col-lg-1.col-md-1.col-sm-1.col-2
        .row
          .col-xxl-5.col-xl-5.col-lg-5.col-md-8.col-sm-10.col-7
    ...
    p Los recursos administrativos son el conjunto de recursos con los que opera la empresa para el desarrollo de sus actividades, y que debe asignar a las áreas o departamentos, para que sean utilizados, adecuados, asignados, según corresponda.
    p.text-bold Clases de recursos:
    p.mb-5 Los recursos administrativos se pueden clasificar en cuatro grandes grupos, recursos de talento humano, recursos físicos o tangibles, recursos financieros o monetarios y los recursos intangibles:
    .row.justify-content-center
